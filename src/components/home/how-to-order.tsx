...
const steps = [
  ...
  {
    title: "Посмотрите цвета вживую",
    text: `Закажите раскладку за ${formatRub(company.swatchBookPriceRub)}, чтобы выбрать не по экрану. Её стоимость вычитается из следующего заказа.`,
  },
  {
