...
export type Fabric = {
  ...
  colors?: FabricColor[];
  /**
   * Цвет, снятый на презентационном фото. Само фото - постановочный кадр,
   * отдельный от снимка этого оттенка в палитре; номер нужен, чтобы
   * показать его на кадре и тот не выглядел безымянным отдельным цветом.
   */
  coverCode?: string;
};
